...
```{r}
advancedgoalkeeping21.22 <- read_html("https://fbref.com/en/comps/8/2020-2021/keepersadv/2021-2022-Champions-League-Stats")
...
ps <- rbind(ps22.23, ps21.22, ps20.21, ps19.20, ps18.19) |>
  ...
  mutate(takeons_per_match = Att.x/`90s.x`,
         ...
         kp_per_game = KP/`90s.x`,
crosses_per_game = CrsPA/`90s.x`,
PrgP_per_game = PrgP/`90s.x`,
PrgC_per_game = PrgC/`90s.x`,
takeons_attempted_per_game = Att.x/`90s.x`,
def_third_touches_per_game = `Def 3rd`/`90s.x`,
mid_third_touches_per_game = `Mid 3rd`/`90s.x`,
att_third_touches_per_game = `Att 3rd`/`90s.x`)
