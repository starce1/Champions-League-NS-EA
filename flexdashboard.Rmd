...
gs$Rank <- factor(gs$Rank, levels = legend_order)
  ...
  renderPlotly({
   if (input$rank_pos) 
    ...
    gs |>
  plot_ly(x = ~Gls, y = ~.data[[input$y]], type = 'scatter', mode = 'markers', color = ~ Rank, text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
   ...
   plot_ly(x = ~Gls, y = ~.data[[input$y]], type = 'scatter', mode = 'markers', color = ~ Rank, text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
    ...
    if (input$d == "All Years")
    gs |>
       plot_ly(x = ~Gls, y = ~.data[[input$y]], type = 'scatter', mode = 'markers', text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
      layout(xaxis = list(title = "Goals"),
             yaxis = list(title = if (input$y == "xG")
                                     "Expected Goals"
                                  else if (input$y == "npxG")
...
renderPlot({
  if(!input$penalty)
    if (input$yr == "All Years")
      ...
      geom_density() +
      labs(x = "Non-Penalty Goals minus Non-Penalty Expected Goals", y = "Proportion of Teams")
    else
      gs |>
    ...
    if (input$yr == "All Years")
      ...
      ggplot(aes(x = `G-xG`)) +
      geom_density() +
        labs(x = "Goals minus Expected Goals", y = "Proportion of Teams")
    else
      gs |>
        filter(Year %in% c(input$yr)) |>
        ggplot(aes(x = `G-xG`)) +
...
renderPlotly({
  ...
  plot_ly(x = ~Poss, y = ~.data[[input$y2]], type = 'scatter', mode = 'markers', color = ~ Rank, text = ~paste("Team: ", Squad, '<br>Year: ', Year),
   ...
   plot_ly(x = ~Poss, y = ~.data[[input$y2]], type = 'scatter', mode = 'markers', color = ~ Rank, text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
      layout(xaxis = list(title = "Possession"),
             yaxis = list(title = if (input$y2 == "Att.x")
                                     "Take-Ons Attempted"
                                  else if (input$y2 == "xA")
    ...
    if (input$d1 == "All Years")
    ps |>
       plot_ly(x = ~Poss, y = ~.data[[input$y2]], type = 'scatter', mode = 'markers', text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
      layout(xaxis = list(title = "Possession"),
             yaxis = list(title = if (input$y2 == "Att.x")
                                     "Take-Ons Attempted"
                                  else if (input$y2 == "xA")
...
renderPlot({
  if (input$yr2 == "All Years")
    ...
    ggplot(aes(x = `A-xAG`)) +
    geom_density() +
    labs(x = "Assists minus Expected Goals Assisted", y = "Proportion of Teams")
  else
    ps |>
...
renderPlotly({
   if (input$rank_pos2) 
    ...
    ds |>
  plot_ly(x = ~GA90, y = ~.data[[input$dsv]], type = 'scatter', mode = 'markers', color = ~ Rank, text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
  ...
  layout(legend = list(c("W", "F", "SF", "QF", "R16", "GR")),
    ...
    if (input$d3 == "All Years")
    ds |>
       plot_ly(x = ~GA90, y = ~.data[[input$dsv]], type = 'scatter', mode = 'markers', text = ~paste("Team: ", Squad, '<br>Year: ', Year), height = 300) |>
  layout(legend = list(c("W", "F", "SF", "QF", "R16", "GR")),
           xaxis = list(title = "Goals Against per 90 minutes"),
           yaxis = list(title = if (input$dsv == "Save%")
                                     "Save Percentage"
...
renderPlot({
  if(!input$ninety)
    if (input$yr3 == "All Years")
      ...
      ggplot(aes(x = `PSxG+/-`)) +
      geom_density() +
      labs(x = "Post-Shot Expected Goals minus Goals Allowed", y = "Proportion of Teams")
    else
      ds |>
    ...
    if (input$yr3 == "All Years")
      ...
      ggplot(aes(x = `/90`)) +
      geom_density() +
      labs(x = "Post-Shot Expected Goals minus Goals Allowed per 90 Minutes", y = "Proportion of Teams")
    else
      ds |>
        filter(Year %in% c(input$yr3)) |>
        ggplot(aes(x = `/90`)) +
...
renderPlotly({
total_s |>
  select(Squad, Year, xG, `SoT/90`, xAG, kp_90, takeons_attempted_90, PSxG, tkl_int_90) |>
